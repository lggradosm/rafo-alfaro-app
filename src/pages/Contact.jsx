...
export default function Contact() {
  return (
    <div className="max-w-[90vw] lg:w-4/5 min-h-[calc(100vh-3rem)]  my-headerPage lg:my-0  mx-auto flex flex-col lg:flex-row items-center justify-center gap-16       text-white ">
