...
export default function CollageImage({
  ...
  return (
    ...
    >
      ...
      {type === "team" && (
        <span className="flex w-fit absolute bottom-0 left-0 bg-black p-2 min-w-[100px] text-white text-[.8em] sm:text-[.65em] md:text-xs  whitespace-nowrap  overflow-hidden  font-manrope font-bold tracking-wide">
          {name}
          <span
